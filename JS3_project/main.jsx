...
returnQuestions(){
    ...
    let listOfQuestions = allQuestions.map((question) => 
    
    <li><span className='question-text'>{question.text}</span><br/>
    <span className='right-answer'>{question.a1} (right answer)</span><br/>
    <span className='wrong-answer'>{question.a2} (wrong answer)</span><br/>
    <span className='wrong-answer'>{question.a3} (wrong answer)</span><br/></li>
    )
